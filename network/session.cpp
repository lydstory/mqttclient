...
namespace {
      ...
      const char *g_default_host = "mqtt.urmoney.cn";
     const int g_default_port = 61613;
#else
      const char *g_default_host = "mqtt-cn-45903izk702.mqtt.aliyuncs.com";
...
void Session::set_id(std::string id)
{
    d->id = id;
}
